 ...
 */
public class UIElements extends BaseUIControl {

    private static Logger log = Logger.getLogger(UIElements.class);
    ...
    public boolean verifyText(String expText) {
        ...
        throw new RuntimeException(String.format("Control Text verification failed. Actual - %s, Expected - %s", actText, expText));
    }
