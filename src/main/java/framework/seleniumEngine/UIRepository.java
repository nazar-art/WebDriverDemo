...
public class UIRepository {
    ...
    public static class Pages {
        ...
        public static class GmailLoginPage {
            ...
            public static UIMapping btnLogin = new UIMapping(SearchLevelType.Page, SearchType.ByXpath, "//input[@id='signIn']", UIButton.class);
...
//            public static UIMapping self = new UIMapping(SearchLevelType.Page, SearchType.ByUrl, "/mail/u/0/#inbox", framework.pages.GmailLoginPage.class);
            public static UIMapping self = new UIMapping(SearchLevelType.Page, SearchType.ByUrl, "https://mail.google.com/mail/u/0/?tab=wm#inbox", framework.pages.GmailLoginPage.class);
